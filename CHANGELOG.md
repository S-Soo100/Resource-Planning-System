...
- **README, 데모 시스템 비즈니스 로직, 업데이트 내역 등 문서 최신화**
...
- **권한 시스템 강화**: 데모 시스템과 휠체어 발주에 대한 권한 제어
- **UI/UX 개선**: 공통 컴포넌트를 통한 일관된 사용자 경험
- **캐싱 전략 최적화**: 데모 시스템 30분 캐싱, 댓글 시스템 30초 캐싱
...
- **LLM 수정 가이드라인 업데이트**: 데모 시스템, 휠체어 발주, 댓글 시스템 관련 가이드라인 추가
