...
KARS는 다양한 품목/창고를 가진 기업을 대상으로 하는 자동화 재고관리를 위한 통합 재고 관리 시스템입니다. 이 시스템은 재고 관리, 발주 관리, 패키지 관리, 데모 시연 관리 등 운영에 필요한 핵심 기능을 제공합니다.
...
### v1.5.0 (2025년 1월) - 데모 시스템 및 휠체어 발주 기능 추가
