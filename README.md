...
### 4. 데모 시연 관리 (v1.5.0 추가)

- **데모 요청**: 제품 시연을 위한 별도의 데모 요청 시스템
- **데모 승인**: 관리자의 데모 요청 검토 및 승인
- **데모 상태 관리**: 시연 프로세스에 따른 상태 변경 (요청 → 승인 → 시연출고 → 복귀)
- **재고 연동**: 시연 출고 시 자동 재고 차감 및 복귀 시 재고 복구
- **데모 이력**: 시연 내역 추적 및 기록 관리
