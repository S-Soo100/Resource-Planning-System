...
> **[2025-11-17 v1.14.0] 최신 업데이트**
>
> - **시연 이벤트 날짜 필드 추가 (백엔드 API 2.0)**
>   - `eventStartDate`, `eventEndDate`: 실제 이벤트 개최 기간 기록 (선택 사항)
>   - 시연품 배송 일정(`demoStartDate`/`demoEndDate`)과 실제 이벤트 일정을 구분
>   - 시연 생성/수정 폼에 이벤트 날짜 입력 UI 추가
>   - 시연 상세/인쇄 페이지에 이벤트 기간 표시
>   - 모든 Demo 타입 인터페이스 업데이트 (타입 안정성 강화)

> **[2025-07-23 v1.7.0] 이전 업데이트**
>
