          ...
          <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
            ...
            <div className="flex justify-end items-center pt-4 space-x-3">
              ...
              <button
                ...
                className={`flex items-center px-4 py-2 text-sm font-medium text-white rounded-full focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                  success
