          ...
          <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
            ...
            <div className="flex items-center justify-end space-x-3 pt-4">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {updateUserMutation.isPending ? (
                  <>
                    <LoadingInline />
