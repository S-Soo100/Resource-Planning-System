...
export default function OrderGuidePage() {
  ...
  const steps = [
    {
      id: 0,
      title: "판매 기능 안내",
      description: "설명이 필요한 판매 형식을 선택하고 다음 버튼을 눌러주세요",
      content: (
        <div
    ...
    },
    {
      ...
      description:
        selectedType === "package"
          ? "패키지 판매의 단계별 사용법을 안내합니다"
          : selectedType === "wheelchair"
            ? "휠체어 판매의 단계별 사용법을 안내합니다"
            : "개별 품목 판매의 단계별 사용법을 안내합니다",
      content:
        selectedType === "package" ? (
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                <div className="flex justify-center items-center w-6 h-6 text-xs font-semibold text-gray-900 bg-gray-200 rounded-full flex-shrink-0">
                  1
                </div>
                <div className="flex-1">
                  ...
                  <p className="mb-1 text-gray-600">판매 창고를 선택합니다.</p>
              ...
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-1 text-gray-600">
                    모든 정보를 확인한 후 판매를 요청합니다.
                  </p>
                  <div className="p-1.5 text-gray-900 bg-gray-200 rounded">
                    <span className="font-medium">완료:</span> 판매 요청이
                    접수되었습니다.
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-3">
            <div className="p-2 bg-gray-100 rounded border border-gray-300">
              <div>
                ...
                <p className="text-xs text-gray-700">
                  휠체어 관련 전용 품목을 쉽고 빠르게 선택하여 판매하는
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <div className="p-1.5 space-y-1 bg-gray-100 rounded">
                    <div>
              ...
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-1 text-gray-600">
                    판매증빙서, 견적서, 휠체어 사용자 확인서 등 필요한
                    증빙서류를 업로드합니다.
                  </p>
                  <div className="p-1.5 bg-gray-100 rounded">
                    <span className="font-medium">필수:</span> 판매증빙서,
                    견적서, 휠체어 사용자 확인서
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-1 text-gray-600">
                    모든 정보를 확인한 후 휠체어 전용 판매를 요청합니다.
                  </p>
                  <div className="p-1.5 text-gray-900 bg-gray-200 rounded">
                    <span className="font-medium">완료:</span> 휠체어 판매
                    요청이 접수되었습니다.
                  </div>
                  <div className="p-1.5 mt-1 text-gray-700 bg-gray-100 rounded border border-gray-300">
          ...
          <div className="space-y-3">
            <div className="p-2 bg-gray-100 rounded">
              <div>
                ...
                <p className="text-xs text-gray-700">
                  필요한 품목을 개별적으로 선택하여 판매하는 방식입니다. 특정
                  품목만 필요하거나 패키지에 없는 품목을 판매할 때 사용합니다.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-1 text-gray-600">
                    판매 창고를 선택합니다. 접근 권한이 있는 창고만 표시됩니다.
                  </p>
                  <div className="p-1.5 bg-gray-100 rounded">
                    <span className="font-medium">예시:</span> &quot;서울 본사
                    창고&quot;, &quot;부산 지점 창고&quot;
              ...
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <p className="mb-1 text-gray-600">
                    판매할 품목을 하나씩 선택합니다. 품목명, 코드, 현재 재고를
                    확인할 수 있습니다.
                  </p>
                  <div className="p-1.5 bg-gray-100 rounded">
                    <span className="font-medium">예시:</span> &quot;엔진 오일
              ...
              <div className="flex gap-2 items-start p-2 rounded border border-gray-300 text-xs">
                ...
                <div className="flex-1">
                  ...
                  <div className="p-1.5 mt-1 text-gray-700 bg-gray-100 rounded border border-gray-300">
                    <strong>알림:</strong> 요청자, 승인권자, 관리자에게 이메일
                    알림이 자동 발송됩니다.
                  </div>
                </div>
              </div>
    ...
    },
    {
      id: 2,
      title: "주의사항 및 팁",
      description: "판매 시 알아두어야 할 중요한 정보들",
      content: (
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm text-yellow-700">
                  <li>• 판매 전 현재 재고를 반드시 확인하세요</li>
                  <li>• 증빙서류는 반드시 업로드해야 합니다</li>
                  <li>• 배송 정보는 정확하게 입력해주세요</li>
                  <li>
                    • 판매 요청 후 상태는 &apos;판매 기록&apos;에서 확인할 수
                    있습니다
                  </li>
                </ul>
              </div>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="mb-3 font-medium text-blue-800">
                  판매 요청부터 완료까지 모든 과정에서 자동으로 이메일 알림이
                  발송됩니다!
                </p>
                <div className="space-y-2 text-sm text-blue-700">
                  <div className="flex gap-2 items-center">
                    ...
                    <span>
                      <strong>판매 요청 시:</strong> 요청자, 승인권자,
                      관리자에게 알림
                    </span>
                  </div>
                  <div className="flex gap-2 items-center">
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
            <Card className="p-4">
              <div className="flex gap-2 items-center mb-3">
                ...
                <h4 className="font-semibold">판매 처리 시간</h4>
              </div>
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div>
                  • <strong>일반 사용자:</strong> 판매 요청만 가능
                </div>
                <div>
                  • <strong>1차승인권자:</strong> 판매 승인/반려
                </div>
                <div>
                  • <strong>관리자:</strong> 모든 기능 사용 가능
                </div>
                <div>
                  • <strong>외부업체:</strong> 판매 관련 기능만
                </div>
              </div>
            </Card>
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div>
                  • <strong>판매 문의:</strong> 품목 및 수량 관련
                </div>
                <div>
  ...
  const handleStartOrder = () => {
    if (selectedType === "package") {
      ...
      router.push("/salesWheelchair");
    } else {
      router.push("/salesRequest");
    }
  };
    ...
    <div className="py-8 min-h-screen bg-gray-50">
      <div className="container px-4 mx-auto max-w-7xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">
            패키지 판매와 개별 품목 판매의 사용법을 단계별로 안내합니다
          </p>
        </div>
        ...
        <div className="mb-8">
          <div className="p-8 bg-white rounded-2xl border border-gray-200 shadow-xl">
            ...
            >
              ...
              {hasWheelchairWarehouses && (
                <button
                  onClick={() => router.push("/salesWheelchair")}
              ...
              {/* 개별 품목 판매 */}
              <button
                onClick={() => router.push("/salesRequest")}
