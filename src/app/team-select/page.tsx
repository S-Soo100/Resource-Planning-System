...
export default function TeamSelectPage() {
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50">
        <div className="p-8 w-full max-w-md bg-red-50 rounded-lg border-2 border-red-500 shadow-lg">
          ...
          <button
            ...
            className="px-4 py-2 mt-4 text-white bg-red-600 rounded transition-colors hover:bg-red-700"
          >
            다시 시도
          </button>
        </div>
    ...
    <Suspense>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <div className="sticky top-0 z-10 p-3 w-full bg-white shadow-sm">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="flex gap-2 items-center px-4 py-2 text-red-600 bg-red-50 rounded-md transition-colors hover:bg-red-100"
            >
              <LogOut size={18} />
              <span>로그아웃</span>
            </button>
        ...
        <div className="p-6">
          ...
          {/* 현재 선택된 팀 */}
          {selectedTeam && (
            <div className="p-6 mb-8 bg-green-50 rounded-lg border border-green-200 shadow-sm">
          ...
          <div className="p-6 mb-8 bg-white rounded-lg shadow-md">
            <div className="flex items-center mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-2 w-6 h-6 text-blue-500"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          {/* 도움말 영역 */}
          <div className="p-6 mb-8 bg-blue-50 rounded-lg border border-blue-100">
      ...
      {isModalOpen && (
        <div className="flex fixed inset-0 z-50 justify-center items-center bg-black bg-opacity-50">
          <div className="p-6 w-96 max-w-full bg-white rounded-lg shadow-xl">
            <div className="flex items-center mb-4">
              <div className="flex justify-center items-center mr-3 w-10 h-10 bg-blue-100 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mb-4">
              ...
              <input
                id="teamName"
                type="text"
                className="px-4 py-2 w-full rounded-md border border-gray-300 transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                value={newTeamName}
