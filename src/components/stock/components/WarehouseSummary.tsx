    ...
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{warehouse.warehouseName}</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-green-50 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600">총 재고 수량</p>
              <p className="text-2xl font-bold text-gray-900">{totalQuantity.toLocaleString()}개</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-purple-50 rounded-lg p-4">
          <div className="flex items-center gap-3">
            <FaListUl className="text-2xl text-purple-600" />
            <div>
              <p className="text-sm text-gray-600">관리 카테고리</p>
      ...
      {categories.length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-3">카테고리별 현황</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {categories.map(category => (
              ...
              >
                <p className="font-medium text-gray-900 mb-1">{category.name}</p>
