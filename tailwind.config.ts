...
export default {
  ...
  safelist: [
    ...
    "text-Back-Mid-20",
    "text-Back-High-25",
    "text-Back-Highest-30",
    "text-Text-Highest-100",
    "text-Text-High-90",
    "text-Text-Low-70",
    "text-Text-Lowest-60",
    "text-Primary-Main",
    ...
    "text-Gray-Sub-High-80",
    "text-Gray-Sub-Low-50",
    "text-Gray-Sub-Disabled-40",
    "text-Neutral-White",
    "text-Neutral-Black",
    // border-*
    "border-Back-Lowest-00",
    "border-Back-Low-10",
    "border-Back-Mid-20",
    "border-Back-High-25",
    "border-Back-Highest-30",
    "border-Text-Highest-100",
    "border-Text-High-90",
    "border-Text-Low-70",
    "border-Text-Lowest-60",
    "border-Primary-Main",
    ...
    "border-Gray-Sub-High-80",
    "border-Gray-Sub-Low-50",
    "border-Gray-Sub-Disabled-40",
    // outline-*
  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "login-glow": "loginGlow 2s ease-in-out infinite",
      },
      keyframes: {
        fadeIn: {
        ...
        loginGlow: {
          "0%, 100%": {
            boxShadow: "0 0 0px rgba(91, 91, 214, 0.5)",
          },
          "50%": {
            boxShadow: "0 0 20px rgba(91, 91, 214, 0.3)",
          },
        },
      },
    },
